...
export default function Vison() {
  return (
    <div className="my-8 px-8 lg:px-80 text-center">
      <div className="text-3xl lg:text-5xl text-blue-500 font-bold mb-4">About Wisdom Shelf</div>
      ...
      <button className="my-3 px-8 py-3  bg-blue-500 text-white rounded-lg">
        <Link href={'/'}>
